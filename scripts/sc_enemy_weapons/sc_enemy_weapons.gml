...
function sc_enemy_weapons()
{
    global.EnemyWeapons = {
        e_pistol : new create_weapon_definition({
            ...
            cooldown : 90, magSize : 8, mags : 999, reloadTime : 90,
        ...
        e_rifle : new create_weapon_definition({
            ...
            cooldown : 45, magSize : 30, mags : 999, reloadTime : 75,
        ...
        e_sniper : new create_weapon_definition({
            ...
            cooldown : 180, magSize : 5, mags : 999, reloadTime : 120,
            fireSound : snd_pistol_shot_1
        }),
        e_shotgun : new create_weapon_definition({
            ...
            cooldown : 120, bulletNum : 3, spread : 30, magSize : 6, mags : 999, reloadTime : 120,
