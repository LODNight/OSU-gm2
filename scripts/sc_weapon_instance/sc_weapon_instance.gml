...
/// @param {real}    _mags        Starting reserve mags (-1 = default)
/// @param {real}    _durability  Starting durability (-1 = full)
function create_weapon_instance(_definition, _ammo = -1, _mags = -1, _durability = -1) constructor
{
